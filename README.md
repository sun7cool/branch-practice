...
This repository is designed for practicing Git branch management and basic workflow in a WSL2 Ubuntu environment.

## Project Structure
- `main.py`: A simple python script that prints "hello".
